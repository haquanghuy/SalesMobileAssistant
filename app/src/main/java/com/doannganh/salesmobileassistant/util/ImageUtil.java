...
public class ImageUtil {
    ...
    public void saveImageToSD(Bitmap bitmapImage, String exType) {
        FileOutputStream fileOutputStream = null;
        try {
            fileOutputStream = new FileOutputStream(createFile());
            bitmapImage.compress(
                    exType.toLowerCase().equals("png")?Bitmap.CompressFormat.PNG:Bitmap.CompressFormat.JPEG
    ...
    /*
    new ImageUtil(getApplicationContext()).
    setFileName(namePic).
    save(resource, exType);
