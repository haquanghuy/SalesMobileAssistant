...
public class CustomAdapterListViewWithTextView extends ArrayAdapter {
    Activity activity;
    int layout;
    List<String> list;

    public CustomAdapterListViewWithTextView(@NonNull Activity activity, int resource, @NonNull List<String> objects) {
